...
export function ContactPage({ theme, language, t, setCurrentPage }: ContactPageProps) {
  ...
  return (
    <>
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-semibold mb-2">{t("contact_page_title")}</h1>
      ...
      <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
        {/* Contact Information */}
        <div>
          <h2 className="text-lg sm:text-xl font-medium mb-4 sm:mb-6">{t("contact_title")}</h2>
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-sm sm:text-base">{t("office")}</p>
                <p className={`text-sm sm:text-base ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
                  {language === "fr"
